      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/calculators/mortgage/compare" className="text-navy-400 hover:text-emerald-400 text-sm transition-colors">
                  Compare Mortgages
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-6 border-t border-navy-800 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex gap-4">
            ...
            <Link href="/contact" className="text-navy-500 hover:text-navy-300 text-xs transition-colors">Contact</Link>
